...
//** Send **
char message[14] = { '1', '2', '3', '4', '5', '6', '7', '8', '9', 'a', 'b', 'z',
		'x', 'y' };
// 1: COM-error
...
void EXTI15_10_IRQHandler() {
	if (EXTI_GetITStatus(EXTI_Line14) != RESET) { //## Capture Event rising edge --CAM1--
	...
	} else if (EXTI_GetITStatus(EXTI_Line11) != RESET) { //## Capture Event falling edge --CAM1--
	...
	} else if (EXTI_GetITStatus(EXTI_Line12) != RESET) { //## Capture Event rising edge --CAM2--
